...
<input type="text" name="search_theme_form" id="search-input" class="text" value="" title="<?php print t('Search'); ?>" />
<input type="submit" name="op" id="edit-submit-button" value="<?php print t('Search'); ?>" title="<?php print t('Search'); ?>" class="form-submit" />
