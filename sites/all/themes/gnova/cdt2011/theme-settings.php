...
function cdt2011_settings($saved_settings, $subtheme_defaults = array()) {

  // Get the default values from the .info file.
  $defaults = cdt2011_theme_get_default_settings('cdt2011');
  ...
  $form['cdt2011_zen_tabs'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Use Zen Tabs'),
    '#default_value' => $settings['cdt2011_zen_tabs'],
  ...
  $form['cdt2011_block_editing'] = array(
    ...
    '#default_value' => $settings['cdt2011_block_editing'],
    '#prefix'        => '<strong>' . t('Block Edit Links:') . '</strong>',
  );

  $form['themedev']['cdt2011_rebuild_registry'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Rebuild theme registry on every page.'),
    '#default_value' => $settings['cdt2011_rebuild_registry'],
    '#description'   => t('During theme development, it can be very useful to continuously <a href="!link">rebuild the theme registry</a>. WARNING: this is a huge performance penalty and must be turned off on production websites.', array('!link' => 'http://drupal.org/node/173880#theme-registry')),
    '#prefix'        => '<div id="div-cdt2011-registry"><strong>' . t('Theme registry:') . '</strong>',
    '#suffix'        => '</div>',
  );
...
function _cdt2011_theme(&$existing, $type, $theme, $path) {
  ...
  cdt2011_theme_get_default_settings($theme);
...
function cdt2011_theme_get_default_settings($theme) {
  $themes = list_themes();
