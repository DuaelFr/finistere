...
<?php if($fields['field_bp_nbrestant_value']): ?>
<div class="rest_offer">
<?php print t('%nombre left', array('%nombre'=>format_plural($fields['field_bp_nbrestant_value']->content, '1 offer', '@count offers'))); ?>
</div>
<?php endif; ?>
<?php print $fields['view_node']->content; ?>
<?php if($fields['field_resa_link_url']): ?>
<?php print $fields['field_resa_link_url']->content; ?>
<?php endif; ?>
</div>
</div>
