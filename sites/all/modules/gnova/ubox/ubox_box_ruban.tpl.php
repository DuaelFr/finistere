...
<div id="ubox_box_<?php print $ubox->nid; ?>" class="ubox ubox_box_ruban box_ruban <?php print $ubox->field_ubox_proportionsdisplay_class; ?> ubox_items_<?php print $ubox->field_ubox_itemsnb_value ?>">
	<div class="ruban"><?php if(!empty($ubox->field_ubox_header_label_value) || !empty($ubox->field_ubox_displayedtitle_value)): ?><h2><?php if(!empty($ubox->field_ubox_header_url_value)): ?><a href="<?php print $ubox->field_ubox_header_url_value; ?>"><?php endif; ?><?php print $ubox->field_ubox_displayedtitle_value; ?><?php if(!empty($ubox->field_ubox_header_label_value)): ?><span><?php print $ubox->field_ubox_header_label_value; ?></span><?php endif; ?><?php if(!empty($ubox->field_ubox_header_url_value)): ?></a><?php endif; ?></div></h2><?php endif; ?>
