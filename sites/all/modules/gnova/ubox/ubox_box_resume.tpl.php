...
<div id="ubox_box_<?php print $ubox->nid; ?>" class="ubox ubox_box_resume <?php print $ubox->field_ubox_proportionsdisplay_class; ?> ubox_items_<?php print $ubox->field_ubox_itemsnb_value ?>">
